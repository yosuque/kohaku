...
MCP Apps transport profile for a kohaku host.
...
```bash
npm install @kohaku-ui/host-mcp-apps
```
...
- Source: https://github.com/yosuque/kohaku/tree/main/packages/host-mcp-apps
