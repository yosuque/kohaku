...
Isolated execution for kohaku's free-form (L2) output: opaque iframe, restrictive CSP and an allowlisted bridge.
...
```bash
npm install @kohaku-ui/sandbox jsdom react zod
```

Subpath entries: `@kohaku-ui/sandbox/react`, `@kohaku-ui/sandbox/smoke`
...
- Source: https://github.com/yosuque/kohaku/tree/main/packages/sandbox
