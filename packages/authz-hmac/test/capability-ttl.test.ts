...
describe("authz-hmac's re-exported DEFAULT_CAPABILITY_TTL_SECONDS", () => {
  it("is the same value as spec-core's (would fail if authz-hmac reintroduced a local copy)", () => {
