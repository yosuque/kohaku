// Copied from packages/renderer-wc/test/parity/axe-config.ts (the console is an isolated fragment rendered
// under jsdom for the same reasons); keep the two lists in sync by hand.
//
